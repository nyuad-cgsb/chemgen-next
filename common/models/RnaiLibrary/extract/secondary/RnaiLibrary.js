    ...
    return new Promise(function (resolve, reject) {
        if (!lodash_1.get(workflowData, 'platePlanId')) {
            ...
            if (lodash_1.isEmpty(workflowData.platePlan) || lodash_1.isNull(workflowData.platePlan)) {
                ...
                Object.keys(workflowData.platePlan).map(function (well) {
                    if (workflowData.platePlan.well instanceof Array) {
                        workflowData.platePlan.well.map(function (wellData) {
                            libraryInfoList_1 = getPlatePlanWell(wellData, well, libraryInfoList_1);
                        });
                    }
                    else if (workflowData.platePlan.well instanceof Object) {
                        libraryInfoList_1 = getPlatePlanWell(workflowData.platePlan.well, well, libraryInfoList_1);
                    }
                    else {
